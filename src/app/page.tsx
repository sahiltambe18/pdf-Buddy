    ...
    <>
      <MaxWidthWraapper className="mb-12 mt-28 sm:mt-28 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Jarvis allows you to have conversation with any document. Just Upload
          your file and start chatting.
        </p>
        <Link
          href={"/dashboard"}
        ...
        <div className="relative isolate">
          ...
          <div className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/3 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-6  sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto my-32 sm:mt-56 max-w-5xl">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files has never been easier than with JARVIS.
            </p>
          </div>
        </div>
